...
export function Products ({ currentItems }){
  ...
  const handleClose = (event, data) => {console.log(event + data); setShow(false);}
  const handleShow = (event, data) => {console.log(event + data); setShow(true);}
    return (
        ...
        currentItems.map(((item) => (
          ...
          <button onClick={handleShow}>more pics</button>
         


          <Modal key={item.gtin} show={show} onHide={handleClose}>
