...
export function Products ({ currentItems } , props){
  ...
  const handleShow = (e) => e.setShow(true);
    return (
        ...
        currentItems.map(((item) => (
          ...
          <Modal key={item.gtin} show={show} onHide={props.handleClose}>
            
            <img src={item.additional_image_link.split(',')}/>
            <ModalFooter>
            <button onClick={props.handleClose} className="close-btn">Cancel</button>
            </ModalFooter>
          </Modal>
          </div>
