  ...
  const hideModal = () => {
    ...
    return (
        ...
        currentItems.map(((item) => (
          ...
          <button onClick={showModal}>{item.additional_image_link}</button>
          
          <Modal show={isOpen} onHide={hideModal}>
            
              <Carousel>
                { ( () => {
                  const more_images = item.additional_image_link;
                  // console.log(more_images);
                  const rest_images = more_images.split(',');
                  rest_images.forEach(element => {
                    console.log(element);
                  });
                  rest_images.map((img) => {
                    console.log(img);
