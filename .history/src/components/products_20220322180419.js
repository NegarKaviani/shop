  ...
  const hideModal = () => {
    ...
    return (
        ...
        currentItems.map(((item ) => (
          ...
          <div show={isOpen} onHide={hideModal}>
          <img src={item.additional_image_link.split(',').map((pic) => pic)} />
            {item.additional_image_link.split(',')}
            { () => { const more_pics = item.additional_image_link.split(',');
                {more_pics.map(((pic) => (
